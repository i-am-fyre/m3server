...
SpellAuraProcResult Unit::HandleDummyAuraProc(Unit* pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const* procSpell, uint32 procFlag, uint32 procEx, uint32 cooldown)
{
    ...
    switch(dummySpell->GetSpellFamilyName())
    {
        ...
        {
            // Magic Absorption
            if (dummySpell->GetSpellIconID() == 459)             // only this spell have GetSpellIconID() == 459 and dummy aura
            {
        ...
        case SPELLFAMILY_SHAMAN:
        {
            ...
            // Lightning Overload
            if (dummySpell->GetSpellIconID() == 2018)            // only this spell have SpellFamily Shaman GetSpellIconID() == 2018 and dummy aura
            {
